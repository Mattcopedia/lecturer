        ...
        <>
            ...
            <div
                ...
                <PlumFlexColumn>
                  ...
                  <FlexRow2 margin={`0px 0px 33px 0px`} onClick={() => setShowSidebar('-left-64')}>
                    <NeonCarrotRectangle margin={`0px 21px 0px 0px`} />
                    <Image9  src={`https://file.rendit.io/n/9af0U5iG79om2TGSiys3.svg`}  />
                    <Text2 margin={`0px 99px 0px 0px`}>Student</Text2> 
                  ...
                  <NavLink to="/result" >
                  <FlexRow2 margin={`0px 0px 33px 0px`} onClick={() => setShowSidebar('-left-64')}>
                  <NeonCarrotRectangle margin={`0px 23px 0px 0px`} /> 
                    {/* need to fix this */}
                  ...
                  <FlexRow2 margin={`27px 0px 33px 0px`} onClick={() => setShowSidebar('-left-64')}>
