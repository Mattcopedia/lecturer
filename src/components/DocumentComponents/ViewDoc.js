...
import "../br.css" 
import viewdoc from '../../assets/img/viewdoc.PNG'
...
const ViewDoc = () => {
  ...
  return (
    ...
    <div>
       ...
       <FlexColumnRoot>
      <Paragraph> View<br className="responsivemodal"></br> Document</Paragraph> 
     </FlexColumnRoot>
        
       </div>
       <div className="">   
       <ImageRoot src={viewdoc} /> 
       </div>  
     
    </div> 
       
    <SelectAcademicYearRoot>Enter Course Code </SelectAcademicYearRoot>

    <div className=' ml-7 flex flex-row mb-3  '> 
        <div className="box bg-gray-100 pl-2 py-2">
   <select>
    <option selected>CSC 201(Computer Analysis)    </option> 
    <option>CSC 201(Computer Analysis) </option>
    <option>CSC 201(Computer Analysis) </option>
    <option>CSC 201(Computer Analysis) </option>
    <option>CSC 201(Computer Analysis) </option>
  </select> 
      ...
      />
      <div className='  bg-gray-100 pt-1 mr-3 '>
